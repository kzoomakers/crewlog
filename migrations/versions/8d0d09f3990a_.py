...
def upgrade():
    ...
    op.create_table('calendar',
                    sa.Column('id', crewlog.database.GUID(), nullable=False),
    ...
    op.create_table('user',
                    sa.Column('id', crewlog.database.GUID(), nullable=False),
                    sa.Column('alias_id', crewlog.database.GUID(), nullable=False),
    ...
    op.create_table('recur_event',
                    ...
                    sa.Column('calendar_id', crewlog.database.GUID(), nullable=False),
    ...
    op.create_table('role',
                    ...
                    sa.Column('calendar_id', crewlog.database.GUID(), nullable=False),
                    sa.Column('user_id', crewlog.database.GUID(), nullable=False),
    ...
    op.create_table('event',
                    ...
                    sa.Column('all_day', sa.Boolean(), nullable=False),
                    sa.Column('id', crewlog.database.GUID(), nullable=False),
                    sa.Column('recur_id', crewlog.database.GUID(), nullable=True),
    ...
    op.create_table('shift',
                    ...
                    sa.Column('event_id', crewlog.database.GUID(), nullable=False),
